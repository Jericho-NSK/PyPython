...
icon = Image.open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\original_column.png', mode='r').resize((100, 133)).crop()  #
# требуемый размер
...
with open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\column.png', 'wb') as file:  # Сохранение в новый файл
    file.write(icon_arr)
