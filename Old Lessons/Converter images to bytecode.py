...
icon = Image.open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\original_bird_crash.png', mode='r').resize((33, 30)).crop()  #
# требуемый размер
...
with open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\bird_crash.png', 'wb') as file:  # Сохранение в новый файл
    file.write(icon_arr)
