...
icon = Image.open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\chair.png', mode='r').resize((100, 100)).crop()  # требуемый размер
...
with open(r'G:\Python\PyPython\2023-02.2 Flappy Pygame Pet Project\images\new_chair.png', 'wb') as file:  # Сохранение в новый файл
    file.write(icon_arr)
